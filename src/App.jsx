...
function App() {
  ...
  const {
    ...
    loading,
    error,
  } = usefetch("https://dummyjson.com/products/category/mens-shoes?select=title,price,brand,thumbnail")
    ...
    <>
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/checkout"
            element={<Checkout shopbag={shopBag} quantities={quantities} updateQuantity={updateQuantity} />}
          />
        </Routes>
      </Router>
    </>
